...
export const translations = {
  pt: {
    ...
    modules: [
      ...
      { id: 24, label: "Automação SNOW (Damage Entry)", icon: "sparkles", short: "Preenchimento automático", group: "Plataforma do Cliente" },
    ...
    fields: {
      ...
      24: {
        title: "24. Automação SNOW (Damage Report Entry)",
        desc: "Preenche automaticamente o formulário de danos na plataforma SNOW a partir da planilha já gerada pelo SNOW Processor.",
        inputs: [],
        options: [],
  ...
  en: {
    ...
    modules: [
      ...
      { id: 24, label: "SNOW Automation (Damage Entry)", icon: "sparkles", short: "Auto-fill", group: "Platform" },
